...
//   final TotalDb _totalDb = TotalDb();

//   TotalBloc() : super(LoadingTotalList()) {
//     on<GetTotalList>(_onGetTotalList);
//     on<GetTotal>(_onGetTotal);
//   }

//   Future<void> _onGetTotalList(GetTotalList event, Emitter<TotalState> emit) async {
//     emit(LoadingTotalList());
//     try {
//       final totals = await _totalDb.getAllTotals();
//       emit(LoadedTotalList(totals));
//     } catch (e) {
//       emit(ErrorTotalState(e.toString()));
//     }
//   }

//   Future<void> _onGetTotal(GetTotal event, Emitter<TotalState> emit) async {
//     emit(LoadingTotalList());
//     try {
//       final total = await _totalDb.getById(event.id);
//       emit(LoadedMonthlySummary(total));
//     } catch (e) {
//       emit(ErrorTotalState(e.toString()));
//     }
//   }
